...
from train_cascaded import add_model_arguments, get_params, get_transducer_model
...
def decode_one_batch(
    ...
    if params.simulate_streaming:
        ...
        encoder_out, encoder_out_lens = model.cascade_encoder(encoder_out, encoder_out_lens)
